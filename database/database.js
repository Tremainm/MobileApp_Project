...
const SEED_ITEMS = [
  ...
  { id: '5', name: 'Broccoli', category: 'Fruit&Veg', quantity: 2, unit: 'heads', location: 'Fridge', expiryDate: getDateFromNow(3) },
  { id: '6', name: 'Bananas', category: 'Fruit&Veg', quantity: 6, unit: 'pcs', location: 'Counter', expiryDate: getDateFromNow(6) },
